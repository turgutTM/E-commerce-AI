  ...
  return (
    <div className="relative h-[24rem]">
      ...
      <div className="w-full h-full gap-3 flex flex-col justify-center items-center text-white font-bold absolute top-0 left-0">
        ...
        <p className="text-3xl font-bold">Up to <span className="text-orange-500">70% Off</span> - All Technology Porducts</p>
        <button onClick={() =>router.push("/shop")} className="bg-white mt-2 hover:bg-orange hover:text-white duration-150  text-black tracking-wide p-3 rounded-md">
