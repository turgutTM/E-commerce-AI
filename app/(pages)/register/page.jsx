    ...
    <div className="flex min-h-screen">
      <div className="w-full lg:w-3/5 p-8 lg:p-16 xl:p-24 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="mb-10">
            <p className="text-gray-500 font-medium">Join Us Today</p>
            <h2 className="text-4xl font-bold mt-2 text-gray-800">Sign Up</h2>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                I agree to the <a href="/terms" className="text-orange-600 hover:text-orange-500">Terms of Service</a> and <a href="/privacy" className="text-orange-600 hover:text-orange-500">Privacy Policy</a>
              </label>
            </div>
      ...
      <div className="hidden lg:block lg:w-2/5 relative bg-gradient-to-br from-orange-50 to-orange-100 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-10 text-center">
          <p className="text-gray-800 font-medium">"Start your shopping journey today"</p>
          <p className="text-gray-600 text-sm mt-1">Create your TUGU account in seconds</p>
        </div>
      </div>
    </div>
  );
